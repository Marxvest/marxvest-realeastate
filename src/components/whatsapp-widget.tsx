...
export function WhatsAppWidget() {
  return (
    <a
      ...
      className="fixed bottom-5 right-4 z-50 inline-flex h-14 w-14 items-center justify-center rounded-full border border-white/60 bg-[#1fa855] text-white shadow-[0_24px_60px_rgba(10,21,52,0.28)] transition hover:-translate-y-0.5 hover:shadow-[0_28px_70px_rgba(10,21,52,0.35)] sm:bottom-6 sm:right-6"
    >
