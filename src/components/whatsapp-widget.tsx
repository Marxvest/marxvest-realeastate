...
export function WhatsAppWidget() {
  return (
    <a
      ...
      className="fixed right-3.5 top-1/2 z-50 inline-flex h-9 w-9 translate-y-[3.3rem] items-center justify-center rounded-full border border-white/60 bg-[#1fa855] text-white shadow-[0_24px_60px_rgba(10,21,52,0.28)] transition hover:translate-y-[3.1rem] hover:shadow-[0_28px_70px_rgba(10,21,52,0.35)] sm:top-auto sm:right-7 sm:h-12 sm:w-12 sm:translate-y-0 sm:hover:-translate-y-0.5 sm:bottom-[6.9rem]"
    >
      <span className="whatsapp-ping absolute inset-0 rounded-full border border-white/50" />
      <svg
        aria-hidden="true"
        viewBox="0 0 24 24"
        className="relative h-4.5 w-4.5 fill-current sm:h-6 sm:w-6"
      >
