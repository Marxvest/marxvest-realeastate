...
export function WhatsAppWidget() {
  return (
    <a
      ...
      className="fixed bottom-[18px] right-[18px] z-50 inline-flex h-[3rem] w-[3rem] items-center justify-center rounded-full border border-white/60 bg-[#1fa855] text-white shadow-[0_24px_60px_rgba(10,21,52,0.28)] transition hover:-translate-y-0.5 hover:shadow-[0_28px_70px_rgba(10,21,52,0.35)] sm:bottom-6 sm:right-6 sm:h-[3.25rem] sm:w-[3.25rem]"
    >
      <span className="whatsapp-ping absolute inset-0 rounded-full border border-white/50" />
      <svg
        aria-hidden="true"
        viewBox="0 0 24 24"
        className="relative h-6 w-6 fill-current sm:h-7 sm:w-7"
      >
